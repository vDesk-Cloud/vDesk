...
const vDesk = (function() {
    ...
    /**
     * Flag indicating whether the icons of vDesk already have been compiled.
     * @type {Boolean}
     */
    let Compiled = false;
    ...
    return {
        ...
        Run() {
            ...
            /* Header.MainMenu.Add(
                 new vDesk.MainMenu.Item(
                     vDesk.Locale["vDesk"]["Help"],
                     "Unknown",
                     vDesk.Locale["vDesk"]["HelpDescription"],
...
const Ensure = {
    ...
    Parameter: function(Value, Type, Name, Nullable = false, Throw = null) {
        ...
        //Check if a function (class) has been passed.
            ...
            Error = new TypeError(
                `Value passed to parameter '${Name}' must be an instance of ${Type.name || Type.constructor.name}, ${Value.constructor.name || typeof Value} given.`);
        }
    ...
    Property: function(Value, Type, Name, Nullable = false, Throw = null) {
        ...
        //Check if a function (class) has been passed.
            ...
            Error = new TypeError(
                `Value set to property '${Name}' must be an instance of ${Type.name || Type.constructor.name}, ${Value.constructor.name || typeof Value} given.`);
        }
        //Check if a scalar type has been passed.
        else if(typeof Type === "string" && typeof Value !== Type) {
            Error = new TypeError(
