 ...
 * @memberOf vDesk.Archive.Element.Viewer
 * @extends vDesk.Controls.Window
 * @author Kerry <DevelopmentHero@gmail.com>
 * @package vDesk\Archive
 */
vDesk.Archive.Element.Viewer.Window = function ViewerWindow(Element) {
    ...
    this.Content.appendChild(new vDesk.Archive.Element.Viewer(Element).Control);
};