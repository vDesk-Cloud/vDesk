 ...
 * @event vDesk.Controls.EditControl.Text#update
 * @type {CustomEvent}
 * @property {Object} detail The arguments of the 'update' event.
 * @property {vDesk.Controls.EditControl.Text} detail.sender The current instance of the IEditor.
 * @property {String} detail.value The updated value of the IEditor.
 */
/**
 * Fired if the value of the IEditor has been cleared.
 * @event vDesk.Controls.EditControl.Text#clear
 * @type {CustomEvent}
 ...
 * @class Represents a long text type value editor of an EditControl.
 ...
 * @version 1.0.0.
 */
vDesk.Controls.EditControl.Text = function Text(Value = null, Validator = null, Required = false, Enabled = false) {
    ...
    Control.className = "Editor Text TextBox";
...
vDesk.Controls.EditControl.Text.Types = [Extension.Type.Text];
vDesk.Controls.EditControl.Text.Implements(vDesk.Controls.EditControl.IEditor);
