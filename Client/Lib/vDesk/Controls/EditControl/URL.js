 ...
 * @event vDesk.Controls.EditControl.URL#update
 * @type {CustomEvent}
 * @property {Object} detail The arguments of the 'update' event.
 * @property {vDesk.Controls.EditControl.URL} detail.sender The current instance of the IEditor.
 * @property {String} detail.value The updated value of the IEditor.
 */
/**
 * Fired if the value of the IEditor has been cleared.
 * @event vDesk.Controls.EditControl.URL#clear
 * @type {CustomEvent}
 ...
 * @class Represents a string type URL value editor of an EditControl.
 ...
 * @version 1.0.0.
 */
vDesk.Controls.EditControl.URL = function URL(Value = null, Validator = null, Required = false, Enabled = false) {
    ...
    Control.className = "Editor URL TextBox";
    Control.type = Extension.Type.URL;
    Control.value = Value ?? "";
...
vDesk.Controls.EditControl.URL.Implements(vDesk.Controls.EditControl.IEditor);
vDesk.Controls.EditControl.URL.Types = [Extension.Type.URL];