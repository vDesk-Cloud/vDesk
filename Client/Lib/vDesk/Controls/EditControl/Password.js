 ...
 * @event vDesk.Controls.EditControl.Password#update
 * @type {CustomEvent}
 * @property {Object} detail The arguments of the 'update' event.
 * @property {vDesk.Controls.EditControl.Password} detail.sender The current instance of the IEditor.
 * @property {String} detail.value The updated value of the IEditor.
 */
/**
 * Fired if the value of the IEditor has been cleared.
 * @event vDesk.Controls.EditControl.Password#clear
 * @type {CustomEvent}
 ...
 * @class Represents a masked string type value editor of an EditControl.
 ...
 * @version 1.0.0.
 */
vDesk.Controls.EditControl.Password = function Password(Value = null, Validator = null, Required = false, Enabled = false) {
    ...
    Control.className = "Editor Password TextBox";
...
vDesk.Controls.EditControl.Password.Implements(vDesk.Controls.EditControl.IEditor);
vDesk.Controls.EditControl.Password.Types = [Extension.Type.Password];