...
vDesk.Controls.EditControl.Color = function Color(Value = null, Validator = null, Required = false, Enabled = false) {
    ...
    Object.defineProperties(this, {
        ...
        Validator: {
            ...
            set:        Value => {
                ...
                ColorPicker.Mode = (Validator || {Mode: vDesk.Media.Drawing.ColorPicker.RGBA | vDesk.Media.Drawing.ColorPicker.HSLA | vDesk.Media.Drawing.ColorPicker.Hex}).Mode;
                Validator = Value;
            }
        },
        Valid:     {
    ...
    const ColorPicker = new vDesk.Media.Drawing.ColorPicker(
        ...
        (Validator || {Mode: vDesk.Media.Drawing.ColorPicker.RGBA | vDesk.Media.Drawing.ColorPicker.HSLA | vDesk.Media.Drawing.ColorPicker.Hex}).Mode
    );
