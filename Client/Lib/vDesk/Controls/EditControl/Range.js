 ...
 * @event vDesk.Controls.EditControl.Range#update
 * @type {CustomEvent}
 * @property {Object} detail The arguments of the 'update' event.
 * @property {vDesk.Controls.EditControl.Range} detail.sender The current instance of the IEditor.
 * @property {Number} detail.value The updated value of the IEditor.
 */
/**
 * Fired if the value of the IEditor has been cleared.
 * @event vDesk.Controls.EditControl.Range#clear
 * @type {CustomEvent}
 ...
 * @class Represents a number range type value editor of an EditControl.
 ...
 * @version 1.0.0.
 */
vDesk.Controls.EditControl.Range = function Range(Value = null, Validator = null, Required = false, Enabled = false) {
    ...
    Object.defineProperties(this, {
        ...
        Value:     {
            ...
            get:        () => Control.value.length > 0
                              ? Number.isInteger((Validator || {}).Steps || 1)
        ...
        Validator: {
            ...
            set:        Value => {
                ...
                Control.max = (Value || {}).Max || Number.MAX_SAFE_INTEGER;
    ...
    Control.className = "Editor Range";
    Control.type = Extension.Type.Range;
    Control.value = Value || "";
    Control.min = (Validator || {}).Min || 0;
    Control.max = (Validator || {}).Max || Number.MAX_SAFE_INTEGER;
        ...
        Event => {
            ...
            if(Control.value.length > 0) {
                new vDesk.Events.BubblingEvent("update", {
                    sender: this,
                    value:  Number.isInteger((Validator || {}).Steps || 1)
                            ? Number.parseInt(Control.value)
                            : Number.parseFloat(Control.value)
                }).Dispatch(Control);
            } else {
...
vDesk.Controls.EditControl.Range.Implements(vDesk.Controls.EditControl.IEditor);
vDesk.Controls.EditControl.Range.Types = [Extension.Type.Range];