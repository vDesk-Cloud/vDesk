 ...
 * @event vDesk.Controls.EditControl.Email#update
 * @type {CustomEvent}
 * @property {Object} detail The arguments of the 'update' event.
 * @property {vDesk.Controls.EditControl.Email} detail.sender The current instance of the IEditor.
 * @property {String} detail.value The updated value of the IEditor.
 */
/**
 * Fired if the value of the IEditor has been cleared.
 * @event vDesk.Controls.EditControl.Email#clear
 * @type {CustomEvent}
 ...
 * @class Represents a string type email value editor of an EditControl.
 ...
 * @version 1.0.0.
 */
vDesk.Controls.EditControl.Email = function Email(Value = null, Validator = null, Required = false, Enabled = false) {
    ...
    Control.className = "Editor Email TextBox";
    Control.type = Extension.Type.Email;
    Control.value = Value ?? "";
...
vDesk.Controls.EditControl.Email.Implements(vDesk.Controls.EditControl.IEditor);
vDesk.Controls.EditControl.Email.Types = [Extension.Type.Email];