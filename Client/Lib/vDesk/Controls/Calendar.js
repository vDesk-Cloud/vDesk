...
Object.defineProperties(vDesk.Controls.Calendar, {
    ...
    Days:         {
        enumerable: true,
        get:        () => [
            vDesk?.Locale?.Calendar?.Monday ?? "Monday",
            vDesk?.Locale?.Calendar?.Tuesday ?? "Tuesday",
            vDesk?.Locale?.Calendar?.Wednesday ?? "Wednesday",
            vDesk?.Locale?.Calendar?.Thursday ?? "Thursday",
            vDesk?.Locale?.Calendar?.Friday ?? "Friday",
            vDesk?.Locale?.Calendar?.Saturday ?? "Saturday",
            vDesk?.Locale?.Calendar?.Sunday ?? "Sunday"
        ]
    },
    /**
    ...
    Months:       {
        enumerable: true,
        get:        () => [
            vDesk?.Locale?.CalendarJanuary ?? "January",
            vDesk?.Locale?.CalendarFebruary ?? "February",
            vDesk?.Locale?.CalendarMarch ?? "March",
            vDesk?.Locale?.CalendarApril ?? "April",
            vDesk?.Locale?.CalendarMay ?? "May",
            vDesk?.Locale?.CalendarJune ?? "June",
            vDesk?.Locale?.CalendarJuly ?? "July",
            vDesk?.Locale?.CalendarAugust ?? "August",
            vDesk?.Locale?.CalendarSeptember ?? "September",
            vDesk?.Locale?.CalendarOctober ?? "October",
            vDesk?.Locale?.CalendarNovember ?? "November",
            vDesk?.Locale?.CalendarDecember ?? "December"
        ]
    }
});
