...
vDesk.Controls.EditControl = function EditControl(
    ...
    Object.defineProperties(this, {
        ...
        Type:      {
            ...
            set:        Value => {
                ...
                Type = Value;
                const IEditor = Object.values(vDesk.Controls.EditControl).find(IEditor => ~IEditor?.Types?.indexOf(Value) ?? -1);
    ...
    const IEditor = Object.values(vDesk.Controls.EditControl).find(IEditor => ~(IEditor?.Types?.indexOf(Type) ?? -1));
    if(IEditor === undefined) {
