...
Object.defineProperties(vDesk.Controls.DatePicker, {
    ...
    Days:   {
        enumerable: true,
        get:        () => [
            vDesk?.Locale?.Calendar?.SundayShort ?? "Sun",
            vDesk?.Locale?.Calendar?.MondayShort ?? "Mon",
            vDesk?.Locale?.Calendar?.TuesdayShort ?? "Tue",
            vDesk?.Locale?.Calendar?.WednesdayShort ?? "Wed",
            vDesk?.Locale?.Calendar?.ThursdayShort ?? "Thur",
            vDesk?.Locale?.Calendar?.FridayShort ?? "Fri",
            vDesk?.Locale?.Calendar?.SaturdayShort ?? "Sat"
        ]
    },
    /**
    ...
    Months: {
        enumerable: true,
        get:        () => [
            vDesk?.Locale?.Calendar?.JanuaryShort ?? "Jan",
            vDesk?.Locale?.Calendar?.FebruaryShort ?? "Feb",
            vDesk?.Locale?.Calendar?.MarchShort ?? "Mar",
            vDesk?.Locale?.Calendar?.AprilShort ?? "Apr",
            vDesk?.Locale?.Calendar?.MayShort ?? "May",
            vDesk?.Locale?.Calendar?.JuneShort ?? "Jun",
            vDesk?.Locale?.Calendar?.JulyShort ?? "Jul",
            vDesk?.Locale?.Calendar?.AugustShort ?? "Aug",
            vDesk?.Locale?.Calendar?.SeptemberShort ?? "Sep",
            vDesk?.Locale?.Calendar?.OctoberShort ?? "Oct",
            vDesk?.Locale?.Calendar?.NovemberShort ?? "Nov",
            vDesk?.Locale?.Calendar?.DecemberShort ?? "Dec"
        ]
    }
});