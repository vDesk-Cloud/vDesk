...
vDesk.PinBoard.Note = function Note(
    ...
    this.Extends(vDesk.Controls.DynamicBox, null, null, Height, Width, Y, X, BoundingSphere);
     ...
     * @listens vDesk.Controls.DynamicBox#event:resized
     ...
     * @listens vDesk.Controls.DynamicBox#event:moved
