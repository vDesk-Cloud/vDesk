...
vDesk.Contacts.Contact.Editor = function Editor(Contact, Enabled = true) {
    ...
    Object.defineProperties(this, {
        ...
        Contact: {
            ...
            set:        Value => {
                ...
                Country.Value = (vDesk.Locale.Countries.find(Country => Country.Code === Value.Country.Code) || {Name: null}).Name;
                Company.Value = (vDesk.Contacts.Companies.find(Company => Company.ID === Value.Company.ID) || {Name: null}).Name;
    ...
    this.Save = function() {
        ...
        const FoundCompany = vDesk.Contacts.Companies.find(ExistingCompany => ExistingCompany.Name === Company.Value) || {ID: null};
        if(Contact.ID === null) {
    ...
    const Country = new vDesk.Controls.EditControl(
        ...
        (vDesk.Locale.Countries.find(Country => Country.Code === Contact.Country.Code) || {Name: null}).Name,
    ...
    const Company = new vDesk.Controls.EditControl(
        ...
        null,
        Extension.Type.Suggest,
        (vDesk.Contacts.Companies.find(Company => Company.ID === Contact.Company.ID) || {Name: null}).Name,
