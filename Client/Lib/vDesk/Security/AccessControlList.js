...
vDesk.Security.AccessControlList.FromDataView = function(DataView) {
    return new vDesk.Security.AccessControlList(
        ...
        //Stoopid Js.. and why on earth does the null coalescing operator not work with undefined members?!?
        DataView.Read !== undefined ? DataView.Read : true,
        DataView.Write !== undefined ? DataView.Write : true,
        DataView.Delete !== undefined ? DataView.Delete : true
    );
};
