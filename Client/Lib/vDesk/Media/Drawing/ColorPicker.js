...
vDesk.Media.Drawing.ColorPicker = function ColorPicker(
    ...
    const Transparency = new vDesk.Controls.EditControl(
        vDesk.Locale["vDesk"]["Transparency"],
        null,
