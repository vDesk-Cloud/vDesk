...
vDesk.Configuration.Remote.Plugins.Log = function Log() {
    ...
    const Table = new vDesk.Controls.Table(
        [
            ...
            {
                Name:  "Date",
                Label: vDesk.Locale["vDesk"]["Date"],
                Type:  Date
            },
            {
                Name:  "Module",
                Label: vDesk.Locale["vDesk"]["Module"],
                Type:  Type.String
            },
            {
                Name:  "Entry",
    ...
    Refresh.textContent = vDesk.Locale["vDesk"]["Refresh"];
    ...
    Clear.style.backgroundImage = `url("${vDesk.Visual.Icons.Delete || vDesk.Visual.Icons.Unknown}")`;
    Clear.textContent = vDesk.Locale["vDesk"]["Clear"];
