...
Modules.Contacts = function Contacts() {
    ...
    const OnContext = Event => {
        ...
        if(
            ...
            && Event.detail.sender instanceof vDesk.Contacts.Contact
            || Event.detail.sender instanceof vDesk.Contacts.Company
        ) {
    ...
    const ContactsTable = new vDesk.Controls.Table(
        [
            ...
            },
            {
                Name:  "Title",
                Type:  Type.String,
                Label: vDesk.Locale["vDesk"]["Title"]
            },
            {
                Name:  "Surname",
                Type:  Type.String,
