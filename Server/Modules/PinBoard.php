...
final class PinBoard extends Module {
     ...
     * Creates a new Note.
     *
     * @param \vDesk\Security\User $Owner   The owner of the Note.
     * @param int                  $X       The horizontal position of the Note.
     * @param int                  $Y       The vertical position of the Note.
     * @param int                  $Width   The width of the Note.
     * @param int                  $Height  The height of the Note.
     * @param string               $Color   The color of the Note.
     ...
     * @param int    $X       The new horizontal position of the Note.
     * @param int    $Y       The new vertical position of the Note.
     * @param int    $Width   The new width of the Note.
     * @param int    $Height  The new height of the Note.
     * @param string $Color   The new color of the Note.
     * @param string $Content The new text content of the Note.
     *
     ...
     * @param int $X  The new horizontal position of the Attachment.
     * @param int $Y  The new vertical position of the Attachment.
     *
