...
final class Messenger extends Module {
     ...
     *
     * @return null|array An array containing the amount of sent private and group Messages.
     */
    public static function Status(): ?array {
        return [
            "MessageCount"      => Expression::Select(Functions::Count("*"))
                                             ->From("Messenger.Messages")(),
            "GroupMessageCount" => Expression::Select(Functions::Count("*"))
                                             ->From("Messenger.GroupMessages")()
        ];
    }
