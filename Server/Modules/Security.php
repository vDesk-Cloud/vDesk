...
final class Security extends Module {
     ...
     *
     * @param string $Ticket The ticket of the user to login.
     *
     * @return \vDesk\Security\User The logged in User.
     * @throws \Exception
     */
     ...
     *
     * @param string $Old The current password of the User.
     * @param string $New The new password to set.
     *
     * @return \vDesk\Security\User The updated User.
     */
     ...
     * @throws \vDesk\Security\UnauthorizedAccessException Thrown if the current User tried to delete the system User.
     *
