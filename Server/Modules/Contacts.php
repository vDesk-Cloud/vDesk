...
final class Contacts extends Module implements ISearch {
     ...
     *
     * @param string $Char   The starting character of the surname of the Contact to get.
     * @param int    $Offset The offset to start to get the Contacts from.
     * @param int    $Amount The amount of Contacts to get.
     *
