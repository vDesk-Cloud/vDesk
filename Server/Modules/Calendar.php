...
final class Calendar extends Module implements ISearch {
     ...
     *
     * @param \DateTime $From The start-date of the time-range.
     * @param \DateTime $To   The end-date of the time-range.
     *
     ...
     * @param \DateTime $Start The new start date of the Event.
     * @param \DateTime $End   The new end date of the Event.
     *
     ...
     *
     * @param int   $ID    The ID of the {@link \vDesk\Calendar\Event}.
     * @param array $Users An array containig the IDs of the Users to add.
     *
     * @throws \vDesk\Security\UnauthorizedAccessException Thrown if the current User doesn't have permissions to update the specified Event.
     */
