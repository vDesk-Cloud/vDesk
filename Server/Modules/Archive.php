...
/**
 * The central Archive Module of vDesk.
 *
...
final class Archive extends Module implements ISearch {
     ...
     *
     * @param \vDesk\Archive\Element $Parent The parent folder Element to get the child Elements of.
     *
     ...
     *
     * @param \vDesk\Archive\Element $Element The destination Element to get its history branch of.
     *
     ...
     *
     * @param \vDesk\Archive\Element $Element The Element to get the Attributes of..
     *
     ...
     *
     * @param \vDesk\Archive\Element $Target   The target folder Element to copy the specified Elements into.
     ...
     * @throws \vDesk\Security\UnauthorizedAccessException
     * @todo Add flag for full copy (abort on missing permission on child Elements and perform a rollback).
     */
     ...
     *
     * @param \vDesk\Archive\Element $Element The Element to rename.
     ...
     *
     * @return \vDesk\Search\Results The found elements.
     */
    public static function Search(string $Value, string $Filter = null): Results {
        ...
        foreach(
            ...
            //@todo Find more convenient way to query permissions.
