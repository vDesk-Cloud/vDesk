...
<?= Code::Variable("vDesk") ?>.<?= Code::Class("Console") ?>.Commands.<?= Code::Function("PointlessCommand") ?> = <?= Code::Async ?> <?= Code::Function ?> (
    Console,
    Arguments = {}
) {
...
<?= Code::Variable("\$Permissions") ?> = \vDesk\DataProvider\<?= Code::Class("Expression") ?>
    ...
    -><?= Code::Function("ToMap") ?>()<?= Code::Delimiter ?>
                ...
                <pre class="Elements"><code><?= Code\Language::PHP ?>
    ...
    <?= Code::If ?>(<?= Code::Variable("\$this") ?>-><?= Code::Field("ID") ?> !== <?= Code::Null ?>) {
        ...
        <div class="Slide Code">
            <div class="API">
                ...
                <pre class="Properties"><code><?= Code\Language::PHP ?>
...
<?= Code::Public ?> <?= Code::Function ?> <?= Code::Function("__construct") ?>() {
    ...
    <?= Code::Variable("\$this") ?>-><?= Code::Function("AddProperties") ?>([
        <?= Code::String("\"Property\"") ?> => [
            \<?= Code::Const("Get") ?> => <?= Code::Keyword("fn") ?>(): ?<?= Code::Keyword("string") ?> => <?= Code::Variable("\$this") ?>-><?= Code::Field("Property") ?>,
            \<?= Code::Const("Set") ?> => <?= Code::Keyword("fn") ?>(<?= Code::Keyword("string") ?> <?= Code::Variable("\$Value") ?>) => <?= Code::Variable("\$this") ?>-><?= Code::Field("Property") ?> = <?= Code::Variable("\$Value") ?>
        ...
        ...
                ...
                <pre class="Controls"><code><?= Code\Language::JS ?>
...
<?= Code::Constant ?> <?= Code::Const("Text") ?> = <?= Code::New ?> <?= Code::Variable("vDesk") ?>.<?= Code::Field("Controls") ?>.<?= Code::Class("EditControl") ?>(
    ...
    {<?= Code::Variable("Expression") ?>: <?= Code::String("\"\\S\"") ?>,  <?= Code::Variable("Max") ?>: <?= Code::Int("255") ?>}
                ...
                <pre class="Collections"><code><?= Code\Language::PHP ?>
...
<?= Code::Keyword("print") ?> (<?= Code::New ?> <?= Code::Class("Collection") ?>([<?= Code::String("\"1\"") ?>, <?= Code::String("\"3\"") ?>, <?= Code::String("\"5\"") ?>, <?= Code::String("\"7\"") ?>, <?= Code::String("\"9\"") ?>]))
    -><?= Code::Function("Map") ?>(<?= Code::Keyword("fn") ?>(<?= Code::Keyword("string") ?> <?= Code::Variable("\$Value") ?>): <?= Code::Keyword("int") ?> => (<?= Code::Keyword("int") ?>)<?= Code::Variable("\$Value") ?>)
    -><?= Code::Function("Filter") ?>(<?= Code::Keyword("fn") ?>(<?= Code::Keyword("string") ?> <?= Code::Variable("\$Value") ?>): <?= Code::Keyword("bool") ?> => <?= Code::Variable("\$Value") ?> >= <?= Code::Int("5") ?>)
    -><?= Code::Function("Reduce") ?>(<?= Code::Keyword("fn") ?>(<?= Code::Keyword("int") ?> <?= Code::Variable("\$Accumulated") ?>, <?= Code::Keyword("int") ?> <?= Code::Variable("\$Value") ?>): <?= Code::Keyword("int") ?> => <?= Code::Variable("\$Accumulated") ?> + <?= Code::Variable("\$Value") ?>, <?= Code::Int("0") ?>)<?= Code::Delimiter ?>
...
<?= Code::Variable("\$Dictionary") ?>-><?= Code::Field("OnAdd") ?>[] = <?= Code::Keyword("fn") ?>(<?= Code::Keyword("int") ?> <?= Code::Variable("\$Value") ?>) => <?= Code::Keyword("echo") ?> <?= Code::Variable("\$Value") ?><?= Code::Delimiter ?>

<?= Code::Variable("\$Dictionary") ?>-><?= Code::Function("Add") ?>(<?= Code::String("\"four\"") ?>, <?= Code::Int("4") ?>)<?= Code::Delimiter ?>
</code></pre>
                <pre class="IO"><code><?= Code\Language::PHP ?>
