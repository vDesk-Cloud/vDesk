...
<article class="Packages">
    ...
    <article class="Package" id="Archive">
        <header>
            ...
            <h4 class="License">License</h4>
            <p class="License"><a target="_blank" href="https://directory.fsf.org/wiki/License:MS-PL">Ms-PL</a></p>
            <h4 class="Dependencies">Dependencies</h4>
            ...
            <h4 class="Configuration">Configuration</h4>
            ...
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Archive.phar") ?>" download>Archive.phar</a></p>
        </header>
    ...
    <article class="Package" id="MetaInformation">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "MetaInformation.phar") ?>" download>MetaInformation.phar</a></p>
        </header>
        <section class="Description">
            <aside onclick="this.classList.toggle('Fullscreen')">
    ...
    <article class="Package" id="Pinboard">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Pinboard.phar") ?>" download>Pinboard.phar</a></p>
        </header>
        <section class="Description">
            <ul class="Features">
    ...
    <article class="Package" id="Calendar">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Calendar.phar") ?>" download>Calendar.phar</a></p>
        </header>
        <section class="Description">
            <aside onclick="this.classList.toggle('Fullscreen')">
    ...
    <article class="Package" id="Contacts">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Contacts.phar") ?>" download>Contacts.phar</a></p>
        </header>
        <section class="Description">
            <aside onclick="this.classList.toggle('Fullscreen')">
    ...
    <article class="Package" id="Messenger">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Messenger.phar") ?>" download>Messenger.phar</a></p>
        </header>
        <section class="Description">
            <ul class="Features">
    ...
    <article class="Package" id="Colors">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Colors.phar") ?>" download>Colors.phar</a></p>
        </header>
        <section class="Description">
            <aside onclick="this.classList.toggle('Fullscreen')">
    ...
    <article class="Package" id="Locale">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Locale.phar") ?>" download>Locale.phar</a></p>
        </header>
        <section class="Description">
            <ul class="Features">
    ...
    <article class="Package" id="Security">
        <header>
            ...
            <h4 class="License">License</h4>
            <p>
                <a target="_blank" href="https://directory.fsf.org/wiki/License:MS-PL">Ms-PL</a>
            </p>
            <h4 class="Dependencies">Dependencies</h4>
            <ul class="Dependencies">
                <li><a href="#Configuration">Configuration</a></li>
    ...
    <article class="Package" id="Search">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Search.phar") ?>" download>Search.phar</a></p>
        </header>
        <section class="Description">
            <ul class="Features">
    ...
    <article class="Package" id="Console">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Console.phar") ?>" download>Console.phar</a></p>
        </header>
        <section class="Description">
            <aside onclick="this.classList.toggle('Fullscreen')">
    ...
    <article class="Package" id="Pages">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Pages.phar") ?>" download>Pages.phar</a></p>
        </header>
    </article>
    <article class="Package" id="Homepage">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Homepage.phar") ?>" download>Homepage.phar</a></p>
        </header>
    </article>
    <article class="Package" id="Documentation">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Documentation.phar") ?>" download>Documentation.phar</a></p>
        </header>
    </article>
    <article class="Package" id="UpdateHost">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "UpdateHost.phar") ?>" download>UpdateHost.phar</a></p>
        </header>
        <section class="Description">
            <aside onclick="this.classList.toggle('Fullscreen')">
    ...
    <article class="Package" id="Machines">
        <header>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Machines.phar") ?>" download>Machines.phar</a></p>
        </header>
        <section class="Description">
            <ul class="Features">
    ...
    <article class="Package" id="Tasks">
        <header>
            <h3>Tasks</h3>
            <p class="Description">The Machines package provides an OS agnostic process control.</p>
            <p class="License"><a target="_blank" href="https://directory.fsf.org/wiki/License:MS-PL">Ms-PL</a></p>
            <h4>Configuration</h4>
            <ul class="Configuration">
                <li><span title="Required" class="Required">⚠</span> max_execution_time = 0</li>
            ...
            <h4 class="Download">Download</h4>
            <p class="Download"><a href="<?= Functions::URL("Downloads", "Tasks.phar") ?>" download>Tasks.phar</a></p>
        </header>
    </article>
</article>