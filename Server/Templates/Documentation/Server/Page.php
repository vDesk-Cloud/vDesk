...
<html lang="en">
<head>
    <title><?= $Page->Topic?->Title ?? "Documentation of server related topics" ?></title>
...
<main class="Tutorials">
    <header>
        <h1>
            <a href="<?= Functions::URL("vDesk", "Index") ?>">v<span style="color: #2AB0ED">D</span>esk</a>\<a href="<?= Functions::URL("Documentation", "Index") ?>"><span style="color: #2AB0ED">D</span>ocumentation</a>\<a href="<?= Functions::URL("Documentation", "Topic", "Server") ?>"><span style="color: #2AB0ED">S</span>erver</a>
        </h1>
...
<?php if($Topic->Name !== "Index" && $Topic->Name !== "Server"): ?>
                <a class="Tutorial <?= $Topic->Name === $Page->Topic->Name ? "Current" : "" ?>" href="<?= Functions::URL("Documentation", "Category", "Server", "Topic", $Topic->Name) ?>"><?= $Topic->Description ?></a>
<?php endif; ?>
<?php endforeach; ?>
            </nav>
        </section>
