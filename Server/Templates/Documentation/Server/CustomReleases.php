...
<article>
    ...
    <p>
        ...
        To enable bundling of packages, you'll need to have the <a href="<?= Functions::URL("vDesk", "Page", "Packages#Packages") ?>">Packages</a>, for updates the <a
                href="<?= Functions::URL("vDesk", "Page", "Packages#Updates") ?>">Updates</a> for setups the <a href="<?= Functions::URL("vDesk", "Page", "Packages#Setup") ?>">Setup</a> and <a
