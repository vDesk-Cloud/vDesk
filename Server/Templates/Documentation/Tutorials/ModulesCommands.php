...
<ul class="Topics">
    <li>
        ...
        <ul class="Topics">
            ...
            <li><a href="#Overview">Server</a></li>
    ...
    <li><a href="#Commands">Selecting database records</a>
        <ul class="Topics">
...
<hr>
<h3 id="ApplicationFlow">Application-flow</h3>
<p>
