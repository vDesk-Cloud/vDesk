...
<h4 id="PackageManifest">Manifest</h4>
<p>
...
<h4 id="PackagePreparationCleanup">Preparation&Cleanup</h4>
<p>
...
<h4 id="CustomPackages">Custom packages</h4>
<p>
...
<h4 id="CustomInstallers">Custom installers</h4>
<p>
...
<aside class="Note">
    <h4>Info</h4>
    <p>
        The Updates package is currently in development.<br>
        This section will be extended if the final package has been released.<br>
        Expect a very similar format according packages.
    </p>
    <p>
        However, the package system allows the project to be released before it has the ability to install updates,<br>
        because as soon as the Updates-package has been finished, it can be installed into running systems.
    </p>
    <p>
        The following specifications should be considered as "not final" and expected to change in the future.<br>
        Anyway, developers can provide an update in the format described below at their own risk!
    </p>
</aside>
<h4 id="UpdateFormat">Format</h4>
<p>
...
<h4 id="UpdateManifest">Manifest</h4>
<p>
