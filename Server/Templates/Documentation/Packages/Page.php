...
<main class="Tutorials">
    <header>
        <h1>
            <a href="<?= Functions::URL("vDesk", "Index") ?>">v<span style="color: #2AB0ED">D</span>esk</a>\<a href="<?= Functions::URL("Documentation", "Index") ?>"><span style="color: #2AB0ED">D</span>ocumentation</a>\<a href="<?= Functions::URL("Documentation", "Topic", "Packages") ?>"><span style="color: #2AB0ED">P</span>ackages</a>
        </h1>
...
<?php if($ExistingPage->Name !== "Index"): ?>
                <a class="Page <?= $ExistingPage->Name === $Page->Name ? "Current" : "" ?>"
                   href="<?= Functions::URL("Documentation", "Topic", $ExistingPage->Name) ?>">
                    <?= $ExistingPage->Label ?>
                </a>
<?php endif; ?>
<?php endforeach; ?>
