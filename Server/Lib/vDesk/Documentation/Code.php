...
class Code {
    ...
    /**
     * A predefined copy button for transferring code to the clipboard.
     */
    public const Copy = <<<Copy
<button 
    class="Copy"
    title="Copy to clipboard"
    onclick="navigator.clipboard.writeText(this.nextElementSibling.nextElementSibling.children[0].textContent)"
>⎘</button>
Copy;
    ...
    /**
     * Creates an ordered HTML list for line indicators in code blocks filled with a specified amount of list items.
     *
     * @param int $Count The amount of line indicators to create.
     *
     * @return string A HTML string containing a filled ordered HTML list.
     */
    public static function Lines(int $Count): string {
        return "<ol class='Lines'>" . \str_repeat("<li></li>", $Count) . "</ol>";
    }
}