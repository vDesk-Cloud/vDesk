...
class Event extends AccessControlledModel {
    ...
    /**
     * Flag indicating whether the Event is full time.
     *
     * @var bool
     */
    ...
    /**
     * The repeat amount of the Event.
     *
     * @var int|null
     */
     ...
     *
     * @var null|\vDesk\Calendar\Event\Participants
     */
    ...
    public function __construct(
        ...
        $this->AddProperties([
            ...
            "Participants"   => [
                \Get => fn(): ?Participants => $this->Participants ??= new Participants(null, $this->ID),
     ...
     */
    public static function FromDataView($DataView): Event {
        $Event                    = new static(
            $DataView["ID"] ?? null,
