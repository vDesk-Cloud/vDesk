...
class Settings extends StaticSingleton {
     ...
     *
     * @param iterable|null $Local  Initializes the Settings with the specified Dictionary of local Settings.
     * @param iterable|null $Remote Initializes the Settings with the specified Dictionary of remote Settings.
     */
