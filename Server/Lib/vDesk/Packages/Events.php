...
final class Events extends Package implements IPackage {
    ...
    public const Locale = [
        "DE" => [
            "Settings" => [
                "EventDispatcher:Interval" => "Legt den Intervall in Sekunden fest, in dem neue Events versendet werden."
            ]
        ],
        "EN" => [
            "Settings" => [
                "EventDispatcher:Interval" => "Defines the interval in seconds at which new events are dispatched."
            ]
        ]
    ];
    ...
    public static function Install(\Phar $Phar, string $Path): void {
        ...
        Settings::$Local["EventDispatcher"] = new Settings\Local\Settings(["Events" => null], "EventDispatcher");
        Settings::$Remote["EventDispatcher"] = new Settings\Remote\Settings(
            [
    ...
    public static function PostInstall(\Phar $Phar, string $Path): void {
        if(\vDesk\Modules::Installed("Archive")) {
            ...
            $Events->Save();
            Settings::$Local["EventDispatcher"] = new Settings\Local\Settings(["Events" => $Events->ID], "EventDispatcher");
        }
    }
    ...
    public static function Uninstall(string $Path): void {
        ...
        if(\vDesk\Modules::Installed("Archive")) {
            \vDesk\Modules::Archive()::DeleteElements([Settings::$Local["EventDispatcher"]["Events"]]);
        }
