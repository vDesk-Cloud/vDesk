...
final class Locale extends Package {
    ...
    public const Countries = [
        ...
        "NL" => [
            ...
            "BZ" => "Belize",
            "CA" => "Canada",
            "CC" => "Cocos Eilanden (Keeling Eilanden)",
            "CD" => "Congo",
            ...
            "FI" => "Finland",
            "FJ" => "Fiji",
            "FK" => "Falklandeilanden (Malwinen)",
            "FM" => "Micronesië",
            "FO" => "Faroe",
            "FR" => "Frankrijk",
            "GA" => "Gabon",
            "GB" => "Groot-Brittannië en Noord-Ierland",
            "GD" => "Grenada",
            "GE" => "Georgia",
            "GF" => "Frans Guyana",
            "GG" => "Guernsey (Kanaaleiland)",
            "GH" => "Ghana",
            "GI" => "Gibraltar",
            "GL" => "Groenland",
            "GM" => "Gambia",
            ...
            "GR" => "Griekenland",
            "GS" => "South Georgia en de Zuid-Sandwicheilanden",
            "GT" => "Guatemala",
            "GU" => "Guam",
            "GW" => "Guinee-Bissau",
            "GY" => "Guyana",
