...
class Attachment extends Element {
    ...
    /**
     * The Element of the Attachment.
     *
     * @var null|\vDesk\Archive\Element
     */
    private ?AttachmentElement $Element;
    
    /**
     * Initializes a new instance of the Attachment class.
     *
     * @param int|null                    $ID      Initializes the Attachment with the specified ID.
     * @param \vDesk\Security\User        $Owner   Initializes the Attachment with the specified owner.
    ...
    public function __construct(
        ...
        int $X = null,
        int $Y = null,
        AttachmentElement $Element = null
    ) {
     ...
     */
    public static function FromDataView($DataView): Attachment {
        return new static(
            $DataView["ID"] ?? null,
            $DataView["X"] ?? 0,
            $DataView["Y"] ?? 0,
