...
/**
 * Represents a collection of {@link \vDesk\Messenger\Groups\Message} objects.
 *
...
class Chat extends Collection implements IDataView {
     ...
     *
     * @return \vDesk\Messenger\Groups\Chat A Chat created from the specified data view.
     */
    public static function FromDataView(mixed $DataView): Chat {
        return new static(
