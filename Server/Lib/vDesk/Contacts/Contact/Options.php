...
class Options extends Collection implements ICollectionModel {
    ...
    /**
     * The Contact of the Options.
     *
     * @var \vDesk\Contacts\Contact|null
     */
     ...
     *
     * @param iterable|null                $Elements Initializes the Options with the specified set of elements.
     * @param \vDesk\Contacts\Contact|null $Contact  Initializes the Options with the specified Contact.
     */
    public function __construct(?iterable $Elements = [], Contact $Contact = null) {
        parent::__construct($Elements);
        $this->Contact = $Contact;
        $this->AddProperty(
            "Contact",
            [
                \Get => fn(): ?Contact => $this->Contact,
                \Set => fn(Contact $Value) => $this->Contact ??= $Value
            ]
        );
         ...
         */
        $this->OnAdd[] = fn(&$Sender, Option $Option) => $this->Added[] = $Option;
