...
class Contact extends AccessControlledModel {
    ...
    public function __construct(
       ...
       protected ?string $Annotations = null,
     ...
     */
    public static function FromDataView(mixed $DataView): Contact {
        return new static(
            $DataView["ID"] ?? null,
    ...
    public function ToDataView(bool $Reference = false): array {
        return $Reference
            ...
            : [
                ...
                "ZipCode"           => $this->ZipCode,
                "City"              => $this->City,
                "Country"           => $this->Country?->ToDataView(true),
                "Options"           => $this->Options?->ToDataView(),
                "Company"           => $this->Company?->ToDataView(true),
                "Annotations"       => $this->Annotations,
