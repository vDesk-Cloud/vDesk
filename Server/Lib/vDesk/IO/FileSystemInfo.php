...
abstract class FileSystemInfo {
     ...
     *
     * @param null|string $Path The fully qualified name of the new file or directory, or the relative file or directory name.
     */
    abstract public function __construct(string $Path = null);
