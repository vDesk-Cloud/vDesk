...
class Collection implements ICollection {
     ...
     *
     * @todo Use rest operator instead of iterable parameter.
     */
     ...
     *
     * @return mixed|null Returns the first matching element in the Collection, null if no element satisfies a test provided by the
