...
class Queue implements \IteratorAggregate, IEnumerable {
     ...
     *
     * @return null|mixed The element removed from the beginning of the Queue; otherwise if the Queue is emtpy, null.
     */
     ...
     *
     * @return null|mixed The element at the beginning of the Queue; otherwise if the Queue is emtpy, null.
     */
