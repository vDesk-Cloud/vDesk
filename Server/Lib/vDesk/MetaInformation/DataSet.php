...
class DataSet extends Collection implements ICollectionModel {
     ...
     *
     * @var null|\vDesk\MetaInformation\Mask
     */
    private ?Mask $Mask;
     ...
     */
    public function __construct(?iterable $Rows = [], ?int $ID = null, Element $Element = null, Mask $Mask = null) {
     ...
     */
    public static function FromDataView($DataView): DataSet {
    ...
    public static function FromMask(Mask $Mask, Element $Element = null): DataSet {
        return new static(\array_map(fn(Mask\Row $Row): Row => new Row(null, null, $Row), $Mask->ToArray()), null, $Element, $Mask);
    }
