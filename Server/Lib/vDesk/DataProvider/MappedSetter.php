...
abstract class MappedSetter {
     ...
     *
     * @param int|string|null                               $ID         The ID the MappedSetter belongs to.
     * @param bool|null                                     $Changed    A reference to the field or value the setter should use as a
     *                                                                  changed
     *                                                                  state.
     *
     * @param \vDesk\DataProvider\Expression\IUpdate $Expression The Expression to execute to store the requested property's
    ...
    public static function Create(
        ...
        switch($Type) {
            case Type::String:
                return $Nullable
                    ? static function(?string $Value) use (&$Property, &$Changed, &$ID, $Expression, $Field): void {
                        $Changed = $ID !== null
                                   && !$Changed
                                   && $Property !== $Value;
                        if($Changed && $Expression !== null) {
                            $Expression->Where([$Field => $ID])->Execute();
                        }
                        $Property = $Value;
                    }
                    : static function(string $Value) use (&$Property, &$Changed, &$ID, $Expression, $Field): void {
            ...
            case Type::Int:
                return $Nullable
                    ? static function(?int $Value) use (&$Property, &$Changed, &$ID, $Expression, $Field): void {
                        $Changed = $ID !== null
                                   && !$Changed
                                   && $Property !== $Value;
                        if($Changed && $Expression !== null) {
            ...
            case Type::Float:
                return $Nullable
                    ? static function(?float $Value) use (&$Property, &$Changed, &$ID, $Expression, $Field): void {
                        $Changed = $ID !== null
                                   && !$Changed
                                   && $Property !== $Value;
                        if($Changed && $Expression !== null) {
            ...
            case Type::Bool:
                return $Nullable
                    ? static function(?bool $Value) use (&$Property, &$Changed, &$ID, $Expression, $Field): void {
                        $Changed = $ID !== null
                                   && !$Changed
                                   && $Property !== $Value;
                        if($Changed && $Expression !== null) {
            ...
            case Type::Array:
                return $Nullable
                    ? static function(?array $Value) use (&$Property, &$Changed, &$ID, $Expression, $Field): void {
                        $Changed = $ID !== null
                                   && !$Changed
                                   && $Property !== $Value;
                        if($Changed && $Expression !== null) {
            ...
            case Type::Object:
                return $Nullable
                    ? static function(?object $Value) use (&$Property, &$Changed, &$ID, $Expression, $Field): void {
                        $Changed = $ID !== null
                                   && !$Changed
                                   && $Property !== $Value;
                        if($Changed && $Expression !== null) {
            ...
            case \DateTime::class:
                return $Nullable
                    ? static function(?\DateTime $Value) use (&$Property, &$Changed, &$ID, $Expression, $Field): void {
                        $Changed = $ID !== null
                                   && !$Changed
                                   && $Property !== $Value;
                        if($Changed && $Expression !== null) {
            ...
            case Type::Mixed:
                return $Nullable
                    ? static function($Value) use (&$Property, &$Changed, &$ID, $Expression, $Field): void {
                        $Changed = $ID !== null
                                   && !$Changed
                                   && $Property !== $Value;
                        if($Changed && $Expression !== null) {
        ...
        return $Nullable
            ? static function(?IManagedModel $Value) use (&$Property, &$Changed, &$ID, $Expression, $Field): void {
                if($ID !== null) {
