...
class AccessControlList extends Collection implements ICollectionModel {
    ...
    /**
     * The ID of the AccessControlList.
     *
     * @var int|null
     */
    private ?int $ID;
    ...
    /**
     * Flag indicating whether the current User has read permissions.
     *
     * @var bool|null
     */
    ...
    /**
     * Flag indicating whether the current User has write permissions.
     *
     * @var bool|null
     */
    ...
    /**
     * Flag indicating whether the current User has delete permissions.
     *
     * @var bool|null
     */
     ...
     * @param int                                                     $ID      Initializes the AccessControlList with the specified ID.
     ...
     */
    public function __construct(?iterable $Entries = [], ?int $ID = null, bool $Read = true, bool $Write = true, bool $Delete = true) {
     ...
     */
    public static function FromDataView($DataView): AccessControlList {
        return new static(
