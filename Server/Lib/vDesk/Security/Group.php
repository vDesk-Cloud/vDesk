...
class Group implements IModel {
     ...
     *
     * @var null|\vDesk\Security\Group\Permissions
     */
     ...
     * @param \vDesk\Security\Group\Permissions $Permissions Initializes the Group with the specified Collection of Permissions.
     */
    public function __construct(?int $ID = null, string $Name = null, Permissions $Permissions = null) {
        $this->ID          = $ID;
        $this->Name        = $Name;
