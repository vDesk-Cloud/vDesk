...
class Entry implements IManagedModel {
    ...
    /**
     * Flag indicating whether the referenced Group or User of the Entry has read permissions.
     *
     * @var bool|null
     */
    ...
    /**
     * Flag indicating whether the referenced Group or User of the Entry has write permissions.
     *
     * @var bool|null
     */
    ...
    /**
     * Flag indicating whether the referenced Group or User of the Entry has delete permissions.
     *
     * @var bool|null
     */
     ...
     *
     * @param int                        $ID     Initializes the Entry with the specified ID.
