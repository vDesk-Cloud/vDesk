...
class User implements IModel {
    ...
    /**
     * Gets or sets the session ticket of the User.
     *
     * @var string|null
     */
    ...
    /**
     * The amount of failed login attempts of the User.
     *
     * @var int|null
     */
     ...
     *
     * @var null|\vDesk\Security\User\Groups
     */
    private ?\vDesk\Security\User\Groups $Memberships;
    ...
    public function __construct(
        ...
        \vDesk\Security\User\Groups $Memberships = null,
        ?string $Ticket = null
    ) {
        $this->ID               = $ID;
        $this->Name             = $Name;
     ...
     */
    public static function FromDataView($DataView): User {
        return new static(
            $DataView["ID"] ?? null,
            $DataView["Name"] ?? "",
            $DataView["Locale"] ?? "",
    ...
    public function ToDataView(bool $Reference = false): array {
        ...
        return $this->Ticket !== null
            ? [
                ...
                "Email"       => $this->Email,
                "Ticket"      => $this->Ticket,
                "Permissions" => ($this->Permissions ?? new Model())->ToDataView(),
                "Memberships" => ($this->Memberships ?? new Model())->Fill()->ToDataView(true)
            ]
            : [
                "ID"               => $this->ID,
                "Name"             => $this->Name,
                ...
                "Active"           => $this->Active,
                "FailedLoginCount" => $this->FailedLoginCount,
                "Memberships"      => ($this->Memberships ?? new Model())->ToDataView(true)
            ];
    }
}
